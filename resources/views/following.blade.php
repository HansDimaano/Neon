...
@section('content')
    ...
    <div id="content" class="content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-7">
                    <strong class="card-title">Following</strong>
                </div>
                <div class="col-1">
                ...
                <div class="col-1">
                    @if (($page + 1) * $take < Auth::user()->following->count())
                        <a href="{{ route('user.profile.follow.following', $page + 1) }}"> <i
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ml-3 w-100">
                                    ...
                                    <div class="button mt-2 d-flex flex-row align-items-center"> <button
                                            ...
                                            disabled>{{ $item_f->card->card_name }}</button>
                                        <a href="{{ route('user.profile', $item_f->card->user->id) }}"
                                            class="btn btn-sm btn-primary w-100 ml-2">Profile</a>
                                    </div>
                                </div>
                            </div>
                        </div>
